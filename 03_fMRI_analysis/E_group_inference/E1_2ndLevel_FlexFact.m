function E1_2ndLevel_FlexFact(src_dir, SJin, outputfolder, dir_1st, con_images, session_2nd)
...
for sj = 1:numel(SJin)
    ...
    for con = con_images
        for dir = 1:length(dir_1st)
            ...
            temp_dir      = fullfile(src_dir, SJin{sj}, ['ses-' num2str(session_2nd)], dir_1st{dir})
            cd(temp_dir)
