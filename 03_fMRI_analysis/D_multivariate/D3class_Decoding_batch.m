function D3class_Decoding_batch(beta_dir, output_dir, labelnames, dec_type, rad, masks, map_type, labels, grid_C)
...
cfg.results.output = map_type;%,'specificity', 'AUC', 'corr', 'zcorr'};
